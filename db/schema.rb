...
ActiveRecord::Schema.define(version: 2022_02_28_083203) do
  ...
  create_table "assessments", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["email"], name: "index_assessments_on_email", unique: true
    t.index ["reset_password_token"], name: "index_assessments_on_reset_password_token", unique: true
  end
